...
class abWorkerThread(abThread):
    ...
    def set_shared_job_queue(
        self, shared_job_queue: IJobQueue, shared_job_queue_lock: Lock
    ) -> None:
    ...
    def set_shared_queue(
        self, shared_queue: Dict[str, IJobQueue], shared_queue_lock: Dict[str, Lock]
    ) -> None:
